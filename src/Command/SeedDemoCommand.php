...
final class SeedDemoCommand extends Command
{
     ...
     * -1 = pas de créateur (createdBy null).
     * Certains utilisateurs (ex: index 4) n'ont aucun événement.
     */
    private const CREATOR_DISTRIBUTION = [
        0, 1, 1, 2, -1, 1, 2, 3, -1, 0, 1, 2, -1, 3, 1, 5, -1, 2, 0, 1, -1, 3, 2, 1, -1,
    ];
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        for ($i = 0; $i < $eventCount; $i++) {
            ...
            if ($creatorIndex >= 0 && isset($users[$creatorIndex])) {
                $event->setCreatedBy($users[$creatorIndex]);
            } else {
